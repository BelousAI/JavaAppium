...
public class MainPageObject {
    ...
    public boolean isElementLocatedOnTheScreen(String locator) {
        ...
        if (Platform.getInstance().isMW()) {
            ...
            element_location_on_y -= Integer.parseInt(js_result.toString());
        }
    ...
    public void clickElementToTheRightCorner(String locator, String error_message) {
        if (driver instanceof AppiumDriver) {
            ...
            System.out.println("Method clickElementToTheRightCorner() do nothing for platform " + Platform.getInstance().getPlatformVar());
        }
    }
